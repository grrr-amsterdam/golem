<?php
/**
 * Golem_Cli_Command_BuildProject_Strategy_Svn
 ...
 */
class Golem_Cli_Command_BuildProject_Strategy_Svn implements Golem_Cli_Command_BuildProject_Strategy_Interface {
	/**
